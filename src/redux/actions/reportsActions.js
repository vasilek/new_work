...
export const SET_HALF_OR_FULL = "SET_HALF_OR_FULL";
import {
    generateActionFunc
...
export const setHalfOrFull = generateActionFunc(SET_HALF_OR_FULL);
...
export function createTasksReport(obj) {
    return (dispatch, getState) => {
        ...
        const range = getDateRange_(days);
        // console.log("range in reportActions.createTaskReport", range)
